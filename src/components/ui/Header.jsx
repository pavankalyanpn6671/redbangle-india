...
const outsideLinks = [
  {
    ...
    menu: [
      ...
      { title: 'Campaign', href: '/services/campaign' },
      { title: 'Content', href: '/services/content' },
      { title: 'Technology', href: '/services/technology' },
    ],
  },
  {
    title: 'Work',
                ...
                <div className="flex flex-col gap-6 md:gap-8 items-start pb-20">
                  ...
                  >
                    ...
                    <div className="dropdown-menu rounded-lg bg-white py-5 px-6">
                      ...
                      <div>
                        <Link href="/services/campaign">Campaign</Link>
                      </div>
                      <div>
                  ...
                  >
                    ...
                    <div className="dropdown-menu rounded-lg bg-white py-5 px-6">
                      ...
                      <div>
                       ...
                       <div>
                        <Link href="/work/strategy">Strategy</Link>
                      </div>
                      <div>
                        <Link href="/work/campaign">Campaign</Link>
                      </div>
                      <div>
                        <Link href="/work/content">Content</Link>
                      </div>
                      <div>
                        <Link href="/work/technology">Technology</Link>
                      </div>
                    </div>
                  </div>
