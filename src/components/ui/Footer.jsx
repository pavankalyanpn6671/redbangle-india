...
const socials = [
...

  {
    ...
    href: 'https://www.instagram.com/redbangleagency/',
...
const offices = [
  ...
  //   city: 'Mumbai',
  //   location:
  //     '2nd Floor, Silver Rock, 12,  Nandi Durga Road, 1, 1st MainRd, Bengaluru, Kamataka 560046',
  //   href: '#!',
  // },
]
      ...
      <section className="py-15 md:pt-20 md:pb-8 bg-white">
        <div className="container">
          <div className="grid gap-y-15 grid-cols-2 md:grid-cols-5">
            ...
            <div className="">
              <div className={`pointer-events-none ${styles.title}`}>
                <Link
                  href="/industries"
              ...
              <div className={`pointer-events-none ${styles.links}`}>
                <Link
                  href="#!"
                  data-rb-cursor-state="invisible"
                  className="hover:text-rb-red max-w-max"
            ...
            <div className="">
              <div className={styles.title}>EXPLORE MORE</div>
              <div className={styles.links}>
                <Link
                  href="/contact"
                  data-rb-cursor-state="invisible"
          ...
          <div className="w-full lg:flex lg:justify-end lg:mt-4 lg:mt-0 lg:px-4">
            <div className="w-full mt-4 md:mt-0 md:w-1/3 md:flex md:flex-col px-2">
              {links.map((link, index) => (
                <div key={index} className="md:pb-4">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-4 md:mt-0 group max-w-[300px] md:ml-auto border border-rb-black/20 font-everett rounded-md px-4 py-3 flex gap-1 justify-between font-medium items-center duration-300 ease-out hover:border-rb-red"
                  >
