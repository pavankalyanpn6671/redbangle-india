...
function MyGate() {
  ...
  const socials = [
    {
      key: 0,
      href: 'https://twitter.com/intent/post?url=redbangle.com%2Fwork%2Fcreate%2Fmygate-case-study',
      color: '#000',
      icon: <Twitter />,
    },

    {
      type: 'linkedin',
      key: 1,
      href: 'https://www.redbangle.com/work/create/mygate-case-study',
      color: '#006699',
      icon: <Linkedin />,
    },
  ]
  return (
    <>
      ...
      />
      <WorkHeroSection
        title={'EMPOWERING SECURITY GUARDS WITH MYGATE'}
        logo={logo}
        socials={socials}
        tags={tags}
